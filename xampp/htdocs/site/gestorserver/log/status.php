...
<div class="container">
    ...
    <img src="../../images/wm_play.png" width="50" height="50" alt="wm_play"/>
    <a onClick="document.getElementById('pop').style.display='block';" href="log.php">Processar Log</a>
...
<html>
<meta http-equiv="refresh" content="600;URL=/site/gestorserver/log/log.php">
</html>