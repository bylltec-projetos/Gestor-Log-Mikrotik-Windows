<?php // Translation for the Windows version of XAMPP by Violetta Marczyk <viki@vstudio.pl>
    // ---------------------------------------------------------------------
    // GLOBAL
    // ---------------------------------------------------------------------
    ...
    $TEXT['start-text6'] = "Powodzenia, Kay Vogelgesang + Kai 'Oswald' Seidler + Carsten Wiedmann";
    ...
    $TEXT['manuals-list1'] = "
    <ul>
    <li><a href=\"http://httpd.apache.org/docs/2.2/en/\">Dokumentacja Apache 2</a>
    <li><a href=\"http://dev.mysql.com/doc/refman/5.0/en/index.html\">Dokumentacja MySQL</a>
    <li><a href=\"http://www.php.net/manual/en/\">Dokumentacja PHP</a>
    <li><a href=\"http://perldoc.perl.org/\">Dokumentacja Perl</a>
    ...
    $TEXT['components-text3'] = "W katalogu <a href='/licenses/'><b>\\xampp\licenses</b></a> znajduj&#261; si&#281; licencje wszystkich programów.";
    ...
    <li>aby sprawdzi&#263; konfiguracj&#281;, prosz&#281; przes&#322;a&#263; wiadomo&#347;&#263; do postmaster@localhost lub admin@localhost i sprawdzi&#263; wiadomo&#347;ci w folderach: \\xampp\\MercuryMail\\MAIL\\Admin;</li>
    ...
    $TEXT['ADOdb-text'] = "ADOdb jest skrótem od Active Data Objects Data Base. Aktualnie wspierane s&#261; MySQL, PostgreSQL, Interbase, Firebird, Informix, Oracle, MS SQL 7, Foxpro, Access, ADO, Sybase, FrontBase, DB2, SAP DB, SQLite i generic ODBC. Sterowniki do Sybase, Informix, FrontBase i PostgreSQL znajduj&#261; si&#281; w dystrybucjach. Znajduj&#261; si&#281; tutaj \\xampp\\php\\PEAR\\adodb.";
