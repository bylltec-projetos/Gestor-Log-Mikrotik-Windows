<?php
    ...
    $TEXT['start-text5'] = "Y muy importante! Un gran agradecimiento a la colaboración y ayuda de Nemesis, KriS, Boppy, Pc-Dummy y a todos los amigos de XAMPP!";

    $TEXT['start-text6'] = "Os deseamos mucha diversión, Kay Vogelgesang + Kai 'Oswald' Seidler + Carsten Wiedmann";
    ...
    $TEXT['manuals-list1'] = "
    <ul>
    <li><a href=\"http://httpd.apache.org/docs/2.2/en/\">Apache 2 documentation (en Inglés)</a>
    <li><a href=\"http://dev.mysql.com/doc/refman/5.1/en/index.html\">MySQL documentation (en Inglés)</a>
    <li><a href=\"http://www.php.net/manual/en/\">PHP documentation (en Inglés)</a>
    <li><a href=\"http://perldoc.perl.org/\">Perl documentation (en Inglés)</a>
    <li><a href=\"http://wiki.filezilla-project.org/Documentation\">FileZilla FTP Server (en Inglés)</a>
    <li><a href=\"http://wiki.pmail.com/index.php?title=Mercury:Contents\">Mercury Mail Transport Agent (en Inglés)</a>
    </ul>";
    ...
    <li>Para verificar un E-Mail, envíelo a postmaster@localhost y admin@localhost para controlar la llegada en las carpetas \\xampp\\MercuryMail\\MAIL\\Admin;</li>
    ...
    $TEXT['ADOdb-text'] = "ADOdb significa Active Data Objects Data Base y soporta MySQL, PostgreSQL, Interbase, Firebird, Informix, Oracle, MS SQL 7, Foxpro, Access, ADO, Sybase, FrontBase, DB2, SAP DB, SQLite así cómo ODBC. Drivers para Sybase, Informix, FrontBase y PostgreSQL son contribuciones de comunidades. Podeis encontrarlas en \\xampp\\php\\PEAR\\adodb.";
