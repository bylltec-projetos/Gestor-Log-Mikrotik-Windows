<?php
    ...
    $TEXT['start-text5'] = "Veel succes,<br>Kay Vogelgesang + Kai 'Oswald' Seidler + Carsten Wiedmann";
    ...
    <li><a href=\"http://dev.mysql.com/doc/refman/5.1/en/\">MySQL documentatie</a>
    ...
    $TEXT['components-text3'] = "In de directory <a href='/licenses/'><b>\\xampp\licenses</b></a> vindt u alle licenties en README bestanden van deze programma's.";
    ...
    <li>TESTEN: zend een bericht naar postmaster@localhost of admin@localhost en controleer op de aanwezigheid van deze berichten in de volgende mappen: \\xampp\\MercuryMail\\MAIL\\Admin;</li>
