<?php
    ...
    function pageHeader() {
        ...
        echo "<title>{$TEXT['bio-head']}</title>";
        echo "</head><body>";

        echo "<br><h1>".$TEXT['bio-head']."</h1>";
        echo "<p>".$TEXT['bio-by']." Till Gerken<br><a class='black' href='http://www.zend.com/zend/tut/dynamic.php'>http://www.zend.com/zend/tut/dynamic.php</a></p>";
    }
