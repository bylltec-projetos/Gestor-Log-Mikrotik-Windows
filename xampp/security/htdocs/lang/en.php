<?php
    ...
    $TEXT['security-checktomcat-nok'] = "The admin/config user (xampp) for Tomcat Server has an old password (xampp)";
    $TEXT['security-checktomcat-ok'] = "The admin/config user \"xampp\" for Tomcat Server does not exist anymore or has a new password";
    $TEXT['security-checktomcat-out'] = "Tomcat: Could not find the file 'tomcat-users.xml' ...";
    $TEXT['security-checktomcat-text'] = "With this user you can access the administration tool web application for administering Tomcat.";
    $TEXT['security-checktomcat-notinstalled'] = "<i>The Tomcat add-on is not installalled.</i>";
    ...
    $TEXT['mysql-pmasetup'] = "Set a random password for the phpMyAdmin user 'pma':";
    $TEXT['mysql-pmasetup-yes'] = "Yes";
    $TEXT['mysql-pmasetup-no'] = "No";
    ...
    $TEXT['start-text6'] = "Good luck, Kay Vogelgesang + Kai 'Oswald' Seidler + Carsten Wiedmann";
    ...
    <li><a href=\"http://dev.mysql.com/doc/refman/5.1/en/\">MySQL documentation</a>
    <li><a href=\"http://www.php.net/manual/en/\">PHP documentation</a>
    <li><a href=\"http://perldoc.perl.org/\">Perl Dokumentation</a>
    ...
    $TEXT['components-text3'] = "In the directory <a href='/licenses/'><b>\\xampp\licenses</b></a> you will find all licenses files of these programs and used libraries.";
    ...
    <li>to test, please send a message to postmaster@localhost or admin@localhost and check for these messages in the following folders: \\xampp\\MercuryMail\\MAIL\\Admin;</li>
