<?php
    ...
    $TEXT['start-text6'] = "Buon lavoro, Kay Vogelgesang + Kai 'Oswald' Seidler + Carsten Wiedmann";
    ...
    <li><a href=\"http://dev.mysql.com/doc/refman/5.1/en/\">Documentazione MySQL</a>
    <li><a href=\"http://www.php.net/manual/en/\">DocumentazionePHP</a>
    ...
    $TEXT['components-text3'] = "Nella directory <a href='/licenses/'><b>\\xampp\licenses</b></a> tutti i file di licenza per questi programmi.";
    ...
    <li>per eseguire il test, invia un messaggio a postmaster@localhost oppure admin@localhost and controlla la ricezione di questo messaggio nelle cartelle: \\xampp\\MercuryMail\\MAIL\\Admin;</li>
    ...
    $TEXT['ADOdb-text'] = "ADOdb è acronimo per Active Data Objects Data Base. Attualmente supportiamp MySQL, PostgreSQL, Interbase, Firebird, Informix, Oracle, MS SQL 7, Foxpro, Access, ADO, Sybase, FrontBase, DB2, SAP DB, SQLite e database ODBC generici. I driver Sybase, Informix, FrontBase e PostgreSQL sono contributi della comunità. Puoi trovarli nella directory \\xampp\\php\\PEAR\\adodb.";
