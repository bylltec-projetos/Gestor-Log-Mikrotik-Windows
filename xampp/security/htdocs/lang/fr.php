<?php
    ...
    $TEXT['start-text6'] = "Bonne chance,<br>Kay Vogelgesang + Kai 'Oswald' Seidler + Carsten Wiedmann";
    ...
    $TEXT['components-text3'] = "Dans le répertoire <a href='/licenses/'><b>\\xampp\licenses</b></a> vous trouverez toutes les licences de ces programmes.";
    ...
    <li>Pour tester, veuillez envoyer un message à postmaster@localhost ou admin@localhost et verifiez l'existance de ces messages dans les repertoires suivants : \\xampp\\MercuryMail\\MAIL\\Admin;</li>
