<?php //Translation for the Windows version of XAMPP by Marcio <mpg@mpg.com.br>
    ...
    <li><a href=\"http://dev.mysql.com/doc/refman/5.1/en/\">Documentação do MySQL</a>
    ...
    $TEXT['components-text3'] = "No diretório <a href='/licenses/'><b>\\xampp\licenses</b></a> você irá encontrar todas as licenças destes programas.";
    ...
    $TEXT['ADOdb-text'] = "
    ADOdb proporciona uma padronização dos comandos para acesso a banco de dados. Suporta atualmente MySQL, PostgreSQL, Interbase, Firebird, Informix, Oracle, MS SQL 7, Foxpro, Access, ADO, Sybase, FrontBase, DB2, SAP DB, SQLite e ODBC genérico. Os drivers para Sybase, Informix, FrontBase e PostgreSQL são contribuições da comunidade.  Você o encontra em \\xampp\\php\\PEAR\\adodb.";
