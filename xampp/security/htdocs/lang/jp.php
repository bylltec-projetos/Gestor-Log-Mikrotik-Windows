<?php
    ...
    $TEXT['start-text5'] = "これは、とても重要です! ヘルプやサポートに関してNemesis氏, KriS氏, Boppy氏,それにXAMPPの全てのユーザにとても感謝しています!";
    ...
    <li><a href=\"http://dev.mysql.com/doc/refman/5.1/en/\">MySQL ドキュメント</a>
    ...
    $TEXT['components-text3'] = "<a href='/licenses/'><b>\\xampp\licenses</b></a>ディレクトリで、これらのプログラムのライセンスについて確認することができます。";
    ...
    <li>メッセージ送信のテストはpostmaster@localhostかadmin@localhostに送信して、次のフォルダにメッセージが格納されているか確認してください: \\xampp\\MercuryMail\\MAIL\\Admin;</li>
    ...
    $TEXT['ADOdb-text'] = "ADOdbはActive Data Objectsデータベース用にできています。私たちは現在、MySQL, PostgreSQL, Interbase, Firebird, Informix, Oracle, MS SQL 7, Foxpro, Access, ADO, Sybase, FrontBase, DB2, SAP DB, SQLite,そしてgeneric ODBCをサポートしています。 Sybase, Informix, FrontBase, PostgreSQLのドライバーはコミュニティーの貢献で作成されました。あなたは\\xampp\\php\\PEAR\\adodbで見ることができます。";
