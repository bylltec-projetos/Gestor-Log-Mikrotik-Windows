<?php
    ...
    $TEXT['security-checktomcat-nok'] = "Der Admin/Config User (xampp) für den Tomcat Server hat ein altes Passwort (xampp)";
    $TEXT['security-checktomcat-ok'] = "Der Admin/Config User \"xampp\" für den Tomcat Server existiert nicht mehr oder hat ein neues Passwort";
    ...
    $TEXT['mysql-pmasetup'] = "Setze ein zufälliges Passwort für den phpMyAdmin User 'pma':";
    ...
    $TEXT['start-text6'] = "Viel Spaß, Kay Vogelgesang + Kai 'Oswald' Seidler + Carsten Wiedmann";
    ...
    $TEXT['ADOdb-text'] = "ADOdb steht für Active Data Objects Data Base und unterstützt MySQL, PostgreSQL, Interbase, Firebird, Informix, Oracle, MS SQL 7, Foxpro, Access, ADO, Sybase, FrontBase, DB2, SAP DB, SQLite sowie ODBC. Die Sybase, Informix, FrontBase und PostgreSQL Treiber sind Gemeinschaftsbeiträge. Ihr findet es hier unter \\xampp\\php\\PEAR\\adodb.";
