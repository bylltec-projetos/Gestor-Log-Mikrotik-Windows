<?php
    ...
    $TEXT['start-text6'] = "Lykke Til, Kay Vogelgesang + Kai 'Oswald' Seidler + Carsten Wiedmann";
    ...
    <li><a href=\"http://dev.mysql.com/doc/refman/5.1/en/\">MySQL dokumentasjon</a>
    ...
    $TEXT['components-text3'] = "I katalogen <a href='/licenses/'><b>\\xampp\licenses</b></a> vil du finne alle lisens informasjonen for disse programmene.";
    ...
    <li>for å teste, vennligst sendt en melding til postmaster@localhost eller admin@localhost og sjekk for disse meldingene i følgende mappe: \\xampp\\MercuryMail\\MAIL\\Admin;</li>
